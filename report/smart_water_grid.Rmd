...
Based on large blocks of consecutive data seen in exploratory plots and counts of variables exceeding the threshold (>1) we decided to choose the following vitnor variable as response variable, in the following time range
